...
#define ABILITY_IRON_FISTS 82
#define ABILITY_SNIPER 83
#define ABILITY_SIMPLE 84
#define ABILITY_FILTER 85
#define ABILITY_SOLID_ROCK 86
#define ABILITY_TINTED_LENS 87
#define ABILITY_FLOWER_GIFT 88
#define ABILITY_UNAWARE 89
#define ABILITY_ADAPTABILITY 90 //
#define ABILITY_RECKLESS 91 //
#define ABILITY_SKILL_LINK 92 //
#define ABILITY_TECHNICIAN 93 //
#define ABILITY_ICE_BODY 94 //
#define ABILITY_HYDRATATION 95 //
#define ABILITY_HEATPROOF 96 //
#define ABILITY_NO_GUARD 97 //
#define ABILITY_SCRAPPY 98 //
#define ABILITY_RAGE_POINT 99 //
#define ABILITY_SNOW_CLOAK 100 //
#define ABILITY_NORMALIZE 101 //
#define ABILITY_DRY_SKIN 102 //
#define ABILITY_AFTERMATH 103 //
#define ABILITY_SNOW_WARNING 104 //
#define ABILITY_SOLAR_POWER 105 //
#define ABILITY_STALL 106 //
#define ABILITY_RIVALRY 107 //
#define ABILITY_SUPER_LUCKY 108 //
#define ABILITY_POISON_HEAL 109 //
#define ABILITY_STEAD_FAST 110 //
#define ABILITY_FRISK 111 //
#define ABILITY_FOREWARN 112 //
#define ABILITY_ANTICIPATION 113 //
#define ABILITY_KLUTZ 114 //
#define ABILITY_TANGLED_FEET 115 //
#define ABILITY_MOLD_BREAKER 116 //
#define ABILITY_LEAF_GUARD 117 //
#define ABILITY_SLOW_START 118 //
#define ABILITY_GLUTTONY 119 //
#define ABILITY_MAGIC_GUARD 120 //
#define ABILITY_DOWNLOAD 121 //
#define ABILITY_UNBURDEN 122 //
#define ABILITY_MULTITYPE 123 
#define ABILITY_HONEY 124 //
#define ABILITY_QUICK_FEET 125 //
